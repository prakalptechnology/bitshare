...
{
	request.getRequestDispatcher("/profile/"+session.getAttribute("userName")).forward(request, response);
}%>
    ...
    <link rel="stylesheet" href="css/owl.theme.default.min.css">
  <link rel="stylesheet" href="bitStyle.css">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="/bitshare/">BitShare</a></div>

          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                <li><a href="#home-section" class="nav-link">Home</a></li>
                <li><a href="#courses-section" class="nav-link">Projects</a></li>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  ...
                  <p data-aos="fade-up" data-aos-delay="300" onclick="document.getElementById('id02').style.display='block'"><a href="#" class="btn btn-primary py-3 px-5 btn-pill" >Register</a></p>
<div id="id02" class="modal">
	  
	  <form class="modal-content animate" action="/bitshare/signUp" method="post">
	
	    <div class="signIncontainer" style="padding:16px">
	      ...
	      <input type="password" class="form-control" placeholder="Enter Password" name="cnfpsw" required>
	       
		  <label for="uname"><b>Date of Birth</b></label>
	      <input type="date" class="form-control" placeholder="D.O.B" name="dob" required></br>
	
	      <button class="btn btn-primary btn-pill" type="submit">Sign Up</button>
                ...
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="/bitshare/SignIn" method="post" class="form-box">
